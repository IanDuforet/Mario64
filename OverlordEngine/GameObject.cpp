...
void GameObject::RootDraw(const GameContext& gameContext)
{
	...
	for (size_t i = 0; i < m_pComponents.size(); i++)
	{
		m_pComponents[i]->Draw(gameContext);
	}

	//Root-Object Draw
	for (size_t i = 0; i < m_pChildren.size(); i++)
	{
		m_pChildren[i]->RootDraw(gameContext);
	}
}
...
void GameObject::RootDrawShadowMap(const GameContext& gameContext)
{
	...
	for (size_t i = 0; i < m_pComponents.size(); i++)
	{
		m_pComponents[i]->DrawShadowMap(gameContext);
	}

	//Root-Object Draw
 	for (size_t i = 0; i < m_pChildren.size(); i++)
	{
		m_pChildren[i]->RootDrawShadowMap(gameContext);
	}
}
...
void GameObject::RootPostDraw(const GameContext& gameContext)
{
	...
	for (size_t i = 0; i < m_pComponents.size(); i++)
	{
		m_pComponents[i]->PostDraw(gameContext);
	}

	//Root-Object Draw
	for (size_t i = 0; i < m_pChildren.size(); i++)
	{
		m_pChildren[i]->RootPostDraw(gameContext);
	}
}
